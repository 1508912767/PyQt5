...
class SlippedImgWidget(QWidget):
    def __init__(self, bg, fg, *args, **kwargs):
        ...
        # 背景
        self.bgPixmap = QPixmap(bg).scaled(50, 50, Qt.KeepAspectRatio)
        # 前景
        self.pePixmap = QPixmap(fg).scaled(50, 50, Qt.KeepAspectRatio)
        # 最小尺寸(背景右边和下方隐藏10个像素)
...
if __name__ == '__main__':
    ...
    w = SlippedImgWidget('Data/bg.png', 'Data/fg.png')
    w.show()
    sys.exit(app.exec_())
